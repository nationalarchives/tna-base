<!-- NORMAL mega menu -->
<ul class="main-ul"><li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/about" class="toggle-sub-menu">About us</a>
        <ul class="sub-menu"><li class="mobile-home-link"><a href="http://www.nationalarchives.gov.uk/about">About us home</a></li>
    ...
    <li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/education/" class="toggle-sub-menu">Education</a>
        <ul class="sub-menu"><li class="mobile-home-link"><a href="http://www.nationalarchives.gov.uk/education/">Education home</a></li>
            ...
            <li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/education/sessions-and-resources/?resource-type=video-conferences">Videoconferences</a></li>
            <li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/education/sessions-and-resources/?resource-type=virtual-classroom">Virtual classroom</a></li>
    ...
    <li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/help-with-your-research" class="toggle-sub-menu">Help with your research</a>
        <ul class="sub-menu"><li class="mobile-home-link"><a href="http://www.nationalarchives.gov.uk/help-with-your-research">Help with your research home</a></li>
    ...
    <li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/information-management/" class="toggle-sub-menu">Information management</a>
        <ul class="sub-menu"><li class="mobile-home-link"><a href="http://www.nationalarchives.gov.uk/information-management/">Information management home</a></li>
    ...
    <li><a data-gtm="mega-menu" href="http://www.nationalarchives.gov.uk/archives-sector" class="toggle-sub-menu">Archives sector</a>
        <ul class="sub-menu"><li class="mobile-home-link"><a href="http://www.nationalarchives.gov.uk/archives-sector">Archives sector home</a></li>
    ...
    <li><div class="toggle-sub-menu" id="more-link">More…</div>
        <ul class="sub-menu"><li><a data-gtm="mega-menu" href="http://bookshop.nationalarchives.gov.uk/">Bookshop</a></li>
            ...
            <li><a data-gtm="mega-menu" href="https://www.nationalarchives.gov.uk/contact-us/">Contact us</a></li></ul></li>
</ul>
<!-- end mega-menu -->
