...
if ( ! function_exists( 'redirect_if_404' ) ) :
	function redirect_if_404() {
		if ( is_404() ) {
			...
			$requested_page_safe = str_replace( site_url(), 'https://www.nationalarchives.gov.uk' . $pre_path, $requested_page_safe );
			// Format string for redirection app URL with single placeholder
			$redirect_app_url_format = "https://www.nationalarchives.gov.uk/PageNotFound/PageNotFound.aspx?url=%s";
