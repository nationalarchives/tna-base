...
require dirname( __DIR__ ) . '/inc/functions/functions-non-cloud.php';
...
require dirname( __DIR__ ) . '/inc/functions/functions-og-meta.php';
require dirname( __DIR__ ) . '/inc/functions/functions-portal-landing.php';
